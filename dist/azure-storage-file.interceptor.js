...
function AzureStorageFileInterceptor(fieldName, localOptions, azureStorageOptions) {
    let MixinInterceptor = class MixinInterceptor {
        ...
        intercept(context, next) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!file) {
                    common_1.Logger.warn('AzureStorageFileInterceptor', `Can not intercept field "${fieldName}". Did you specify the correct field name in @AzureStorageFileInterceptor('${fieldName}')?`);
                    return next.handle();
                }
                const storageUrl = yield this.azureStorage.upload(file, azureStorageOptions);
...
exports.AzureStorageFileInterceptor = AzureStorageFileInterceptor;
